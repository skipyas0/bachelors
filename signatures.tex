\begin{figurebox}{Feedback Signature}{box:feedbacksig}
...
\begin{figurebox}{Reflection Signature}{box:reflexsig}
...
\begin{figurebox}{Lamarckian Signature}{box:lamarcksig}
...
\begin{figurebox}{Iterative Signature}{box:itersig}
...
\begin{figurebox}{Paraphrase Signature}{box:parasig}
    \hlspan{ctuorange}{Original prompt: \texttt{str} (Prompt to paraphrase)}\\\\
    $\rightarrow$ \\\\
    \hlspan{ctuorange}{Prompt proposal: \texttt{str} (Paraphrased prompt)} \hfill
    \\ \\
    Instructions:
