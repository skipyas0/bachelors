...
Table \ref{tab:optsurvey} offers an overview of discrete PO literature.
\begin{landscape}
    \begin{table}[htbp]
    \centering
    ...
    \toprule
    \textbf{Date} & \textbf{Method} & \textbf{Initialization} & \textbf{Selection} & \textbf{Expansion} \\
    \midrule
    11/2022 & APE\cite{zhou2023largelanguagemodelshumanlevel}           & [placeholder] & [placeholder] & [placeholder] \\
    05/2023 & APO\cite{pryzant2023automaticpromptoptimizationgradient}           & [placeholder] & [placeholder] & [placeholder] \\
    09/2023 & OPRO\cite{yang2024largelanguagemodelsoptimizers}          & [placeholder] & [placeholder] & [placeholder] \\
    09/2023 & Promptbreeder\cite{fernando2023promptbreederselfreferentialselfimprovementprompt} & [placeholder] & [placeholder] & [placeholder] \\
    09/2023 & Evoprompt\cite{guo2024connectinglargelanguagemodels}          & [placeholder] & [placeholder] & [placeholder] \\
    11/2023 & PE2\cite{ye2024promptengineeringpromptengineer}           & [placeholder] & [placeholder] & [placeholder] \\
    02/2024 & PhaseEvo\cite{cui2024phaseevounifiedincontextprompt}      & [placeholder] & [placeholder] & [placeholder] \\
    04/2024 & SAMMO\cite{schnabel2024symbolicpromptprogramsearch}          & [placeholder] & [placeholder] & [placeholder] \\
    06/2024 & MIPROv2\cite{opsahlong2024optimizinginstructionsdemonstrationsmultistage}       & [placeholder] & [placeholder] & [placeholder] \\
    10/2024 & CriSPO\cite{he2024crispomultiaspectcritiquesuggestionguidedautomatic}        & [placeholder] & [placeholder] & [placeholder] \\
    02/2025 & SPO\cite{xiang2025selfsupervisedpromptoptimization}           & [placeholder] & [placeholder] & [placeholder] \\
    \bottomrule
\end{tabularx}
\end{table}
\end{landscape}
