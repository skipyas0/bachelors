...
\begin{figurebox}{Simple Signature}{box:simplesig}
    ...
    \hlbox{brown}{Antonymum: \texttt{str}}
\end{figurebox}
\newpage
...
We will maintain this formatting style whenever showing a \texttt{Signature} structure in the future: \textcolor{ctuorange}{orange inputs}, \textcolor{brown}{brown outputs} and \textcolor{ctublue}{blue instructions}, which are optional.
...
In \ref{box:predictdev} notice the sections of the prompt following prompt engineering principles outlined in \ref{sec:preng}.
...
the majority of outputs. In case of model failure, such as getting stuck in a generation loop, we add a repeated generation
feature.
